 ...
 */
final class Version20210211181016 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE league (id INT AUTO_INCREMENT NOT NULL, level_id INT DEFAULT NULL, category_id INT NOT NULL, label VARCHAR(255) NOT NULL, id_ffh VARCHAR(255) DEFAULT NULL, INDEX IDX_3EB4C3185FB14BA7 (level_id), INDEX IDX_3EB4C31812469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE level (id INT AUTO_INCREMENT NOT NULL, label VARCHAR(255) NOT NULL, rank INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE league ADD CONSTRAINT FK_3EB4C3185FB14BA7 FOREIGN KEY (level_id) REFERENCES level (id)');
        $this->addSql('ALTER TABLE league ADD CONSTRAINT FK_3EB4C31812469DE2 FOREIGN KEY (category_id) REFERENCES category (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE league DROP FOREIGN KEY FK_3EB4C31812469DE2');
        ...
        $this->addSql('ALTER TABLE league DROP FOREIGN KEY FK_3EB4C3185FB14BA7');
